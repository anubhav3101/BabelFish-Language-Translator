from tkinter import * #importing it for gui and designing the translator
import pickle #importing to convert python object into byte code so that it can be stored in dataset
import numpy as np
...
class LangTRans:
    ...
    def main_window(self):
        ...
        self.window.title("English to French Language Translator")
        self.window.resizable(width=False,height=False)
        self.window.configure(width=420,height=420,bg=BG_COLOR)
    
        head_label=Label(self.window,bg=BG_COLOR,fg=TEXT_COLOR,text="Translate your code",font=FONT_BOLD,pady=10)
        ...
        send_button=Button(bottom_label,text="Translate",font=FONT_BOLD,width=8,bg="#fff",command=lambda: self.on_enter(None))        
